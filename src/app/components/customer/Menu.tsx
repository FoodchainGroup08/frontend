    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--warm-white)' }}>
      ...
      {cart.length > 0 && (() => {
        ...
        return (
          <button
            onClick={onGoToCart}
            className="fixed bottom-40 sm:bottom-6 right-6 sm:right-12 flex items-center gap-2 px-5 py-3 rounded-full shadow-lg transition-all hover:scale-105 z-50"
            style={{
