...
export function OrderDetailModal({ order, isOpen, onClose }: OrderDetailModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto" style={{ backgroundColor: 'var(--foodchain-warm-white)' }}>
        <DialogHeader>
          <div className="flex items-start justify-between">
            <div>
              <DialogTitle className="text-2xl" style={{ color: 'var(--foodchain-espresso)' }}>
                Order #{order.id}
              </DialogTitle>
            ...
            <Badge
              ...
              style={{
                backgroundColor:
                  order.status === 'delivered' ? 'var(--foodchain-sage-green)' :
                  order.status === 'cancelled' ? 'var(--foodchain-burnt-orange)' :
                  order.status === 'out-for-delivery' ? 'var(--foodchain-golden-amber)' :
        ...
        <div className="space-y-6 mt-4">
          <div>
            ...
            <div className="space-y-3">
              {order.items.map((item) => (
                <div key={item.id} className="flex items-center justify-between p-3 rounded-md" style={{ backgroundColor: 'var(--foodchain-white)' }}>
                  ...
                  <p style={{ color: 'var(--foodchain-golden-amber)', fontWeight: 600 }}>
            ...
            <div className="mt-4 space-y-2 p-3 rounded-md" style={{ backgroundColor: 'var(--foodchain-white)' }}>
          ...
          <div>
            ...
            <div className="space-y-3 p-3 rounded-md" style={{ backgroundColor: 'var(--foodchain-white)' }}>
              <div className="flex items-start gap-3">
                <Phone className="w-5 h-5 mt-0.5 flex-shrink-0" style={{ color: 'var(--foodchain-espresso)', opacity: 0.6 }} />
                <div>
              ...
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 mt-0.5 flex-shrink-0" style={{ color: 'var(--foodchain-espresso)', opacity: 0.6 }} />
                <div>
                  <p className="text-sm mb-1" style={{ color: 'var(--foodchain-espresso)', opacity: 0.6 }}>
                    Delivery Address
                  </p>
              ...
              {order.deliveryDate && (
                <>
                  <Separator />
                  <div className="flex items-start gap-3">
                    <Calendar className="w-5 h-5 mt-0.5 flex-shrink-0" style={{ color: 'var(--foodchain-espresso)', opacity: 0.6 }} />
                    <div>
                      <p className="text-sm mb-1" style={{ color: 'var(--foodchain-espresso)', opacity: 0.6 }}>
                        Delivery Date
                      </p>
          ...
          <div>
            ...
            <div className="p-3 rounded-md" style={{ backgroundColor: 'var(--foodchain-white)' }}>
              <div className="flex items-start gap-3">
                <CreditCard className="w-5 h-5 mt-0.5 flex-shrink-0" style={{ color: 'var(--foodchain-espresso)', opacity: 0.6 }} />
                <div>
                  <p className="text-sm mb-1" style={{ color: 'var(--foodchain-espresso)', opacity: 0.6 }}>
                    Payment Method
                  </p>
