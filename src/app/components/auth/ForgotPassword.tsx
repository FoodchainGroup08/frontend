        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-0 shadow-xl" style={{ backgroundColor: 'var(--foodchain-white)' }}>
            <CardHeader className="space-y-1">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full mx-auto mb-4" style={{ backgroundColor: 'var(--foodchain-sage-green)', opacity: 0.1 }}>
              ...
              <CardTitle className="text-2xl text-center" style={{ color: 'var(--foodchain-espresso)' }}>Check your email</CardTitle>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-center" style={{ color: 'var(--foodchain-espresso)', opacity: 0.7 }}>
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-xl" style={{ backgroundColor: 'var(--foodchain-white)' }}>
          <CardHeader className="space-y-1">
            ...
            <CardTitle className="text-2xl" style={{ color: 'var(--foodchain-espresso)' }}>Forgot Password?</CardTitle>
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="email" style={{ color: 'var(--foodchain-espresso)' }}>Email Address</Label>
                <Input
                  id="email"
                  type="email"
